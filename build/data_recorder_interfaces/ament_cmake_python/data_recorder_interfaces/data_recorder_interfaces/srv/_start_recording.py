...
class Metaclass_StartRecording_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('data_recorder_interfaces')
        except ImportError:
            import logging
            import traceback
    ...
    def item_type(self, value):
        if __debug__:
            assert \
                ...
                "The 'item_type' field must be of type 'str'"
...
class Metaclass_StartRecording(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'data_recorder_interfaces.srv.StartRecording')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from data_recorder_interfaces.srv import _start_recording
...
class StartRecording(metaclass=Metaclass_StartRecording):
    from data_recorder_interfaces.srv._start_recording import StartRecording_Request as Request
    from data_recorder_interfaces.srv._start_recording import StartRecording_Response as Response
