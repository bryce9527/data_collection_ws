...
bool open_cyber_glove_ros2__msg__glove_data_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("open_cyber_glove_ros2.msg._glove_data_msg.GloveDataMsg", full_classname_dest, 54) == 0);
  }
  open_cyber_glove_ros2__msg__GloveDataMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // tensile_data
    PyObject * field = PyObject_GetAttrString(_pymsg, "tensile_data");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 19;
      int32_t * dest = ros_message->tensile_data;
      for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // joint_angles
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT32);
      Py_ssize_t size = 22;
      float * dest = ros_message->joint_angles;
      for (Py_ssize_t i = 0; i < size; ++i) {
        float tmp = *(npy_float32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(float));
      }
...
{
  /* NOTE(esteve): Call constructor of GloveDataMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("open_cyber_glove_ros2.msg._glove_data_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GloveDataMsg");
  ...
  {  // tensile_data
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "tensile_data");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    int32_t * src = &(ros_message->tensile_data[0]);
    memcpy(dst, src, 19 * sizeof(int32_t));
    Py_DECREF(field);
  }
  {  // joint_angles
    PyObject * field = NULL;
    ...
    assert(sizeof(npy_float32) == sizeof(float));
    npy_float32 * dst = (npy_float32 *)PyArray_GETPTR1(seq_field, 0);
    float * src = &(ros_message->joint_angles[0]);
    memcpy(dst, src, 22 * sizeof(float));
    Py_DECREF(field);
  }
  {  // timestamp
    PyObject * field = NULL;
